...
<h1>Javascript hardparts-- callbacks.js</h1>
...
function commutative(func1, func2, value) {
  const output1 = func1(func2(value));
  const output2 = func2(func1(value));
...
function highestFunc(objOfFuncs, subject) {
  ...
  for (let key in objOfFuncs) {
    if (objOfFuncs[key](subject) > largestValue) {
      largestValue = objOfFuncs[key](subject);
      resKey = key;
    }
  }
